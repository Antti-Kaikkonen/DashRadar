...
export class CypherComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let defaultQuery = decodeURIComponent("MATCH%20%0A%09(d%3ADay)-%5B%3ALAST_BLOCK%5D-%3E(%3ABlock)-%5B%3ABLOCKCHAIN_TOTALS%5D-%3E(b%3ABlockChainTotals)%0AWITH%0A%09d.day%20as%20date%2C%0A%09b%0AORDER%20BY%20%0A%09date%0AWITH%20%0A%09collect(date)%20as%20dates%2C%0A%090%2Bcollect(b.total_fees_sat)%20as%20fees%0AUNWIND%20%0A%09range(1%2C%20length(fees)-1)%20as%20i%0ARETURN%0A%09dates%5Bi-1%5D*24*60*60%20as%20date%2C%0A%09(fees%5Bi%5D-fees%5Bi-1%5D)%2F100000000.0%20as%20%60Fees%20(Dash)%60%3B");
